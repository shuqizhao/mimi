...
<div class="content-wrapper">
  ...
  <section class="content container-fluid">
       <div class="box">
    <form class="form-horizontal form" onsubmit='return false;' role="form">
        <fieldset>
            <div v-for="item in cfg.items" class="control-group">
                ...
                <div class="controls">
                    ...
                    <div v-if="cfg.mode=='detail'||(cfg.mode=='detailEdit'&&cfg.detailEditMode!='edit')">
                        ...
                        <p v-else style="line-height:29px;"></p>
                    </div>
                    <p class="help-block">
                        {{item.helpblock}}
                    </p>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <!-- Button -->
                    <div v-bind="cfg.mode=='edit'||cfg.mode=='create'">
